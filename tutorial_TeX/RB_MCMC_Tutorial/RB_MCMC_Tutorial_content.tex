...
To use bonsai, download the package source from \href{https://bitbucket.org/mrmay/bonsai/get/7c7416536002.zip}{BONSAI}, launch the R console, and install the package from source (making sure to install the packages that bonsai relies on as well):
{\tt \begin{snugshade*}
\begin{lstlisting}
