...
\caption{\small Screenshot of highlighting a branch in IcyTree showing child node attributes, including the clade posterior probability and the 95\% highest posterior density (HPD) age interval.}
\end{minipage}}
