...
This tutorial demonstrates how to specify the models used in a ``total-evidence'' phylogenetic analysis of extant and fossil species, combining morphological and molecular data as well as stratigraphic range data from the fossil record \citep[\textit{i.e.,}][]{Ronquist2012a}.
...
This tutorial requires that you download and install the latest release of \RevBayes \citep{Hoehna2017a}. 
...
\item Firefox or Google Chrome -- these are the supported web browsers for the phylogenetic tree visualization program, \href{http://tgvaughan.github.io/icytree/}{IcyTree}
\end{itemize}
...
\subsubsection{Incorporating Fossil Stratigraphic Range Data}\label{subsect:Intro-TipSampling}
...
\fbox{%
\begin{minipage}{\textwidth}\centering
\includegraphics[scale=0.3,angle=0]{\ResourcePath figures/tikz/morph_clock_gm}
