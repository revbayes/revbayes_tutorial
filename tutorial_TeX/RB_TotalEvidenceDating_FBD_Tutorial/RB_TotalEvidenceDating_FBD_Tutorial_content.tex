...
For example, we know the likelihood is equal to one whenever $a_i < t_i < b_i$ where $t_i$ is the inferred fossil age, and $(a_i,b_i)$ is the observed stratigraphic interval (see section \ref{subsect:Intro-TipSampling}), which implies $t_i - b_i < 0 < t_i - a_i$.
