...
\caption{\small Screenshot of highlighting a branch in IcyTree showing child node attributes, including the clade posterior probability and the highest posterior density (HPD) age intervals.}
\end{minipage}}
