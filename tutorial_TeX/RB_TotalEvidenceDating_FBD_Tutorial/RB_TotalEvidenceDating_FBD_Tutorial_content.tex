...
%\noindent Download data and output files (if you don't have them already) from: \\ \href{http://revbayes.github.io/tutorials.html}{http://revbayes.github.io/tutorials.html}
...
{\begin{framed}
Return to the master \Rev file you created in Section \ref{sect:StartMasterRev} called {\textcolor{red}{\cl{mcmc\_TEFBD.Rev}}} in the \cl{scripts} directory.
...
\bigskip
\subsection{Summarize Your Results}\label{subsect:SummarizeResults}

\medskip
\subsubsection{Evaluate MCMC}\label{subsub:EvalMCMC}

%TODO this is tracer stuff


\medskip
\subsubsection{Summarize Tree}\label{subsub:SummarizeTree}
