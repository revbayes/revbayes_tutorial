...
We provide the data file which we will use in this tutorial.
You may want to use your own data instead.
Create a folder called \cl{data} and download the following files
\begin{itemize}
\item
\href{http://rawgit.com/revbayes/revbayes_tutorial/master/RB_CTMC_Tutorial/data/primates_cytb.nex}{\cl{primates\_cytb.nex}}: Alignment of the \textit{cytochrome b} subunit from 23 primates representing 14 of the 16 families (\textit{Indriidae} and \textit{Callitrichidae} are missing).
\end{itemize}
