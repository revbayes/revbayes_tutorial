...
\noindent \\ \impmark It is important to note that you can run all of the \Rev~commands from a \RevBayes~script file \cl{source()} function in the \RevBayes~console. If you create a file called \cl{JukesCantor.Rev} and save all of the commands in this file, run the analysis by calling this function:
{\tt \begin{snugshade*}
\begin{lstlisting}
...
\noindent \\ \impmark You should have already downloaded the data files in Section \ref{Sec:data}. Links to additional files, including the scripts to run these analyses can be found on the \href{http://revbayes.github.io/tutorials.html}{\RevBayes~tutorials website}.
