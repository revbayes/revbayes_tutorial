...
Then create a stochastic node called \cl{alpha} to represent the $\alpha$ node in Figure \ref{fig:gtrg}, with an exponential density as a prior:
% I think you mean the GTR+G graphical model figure, which is not included in the tutorial presently...I added it below
