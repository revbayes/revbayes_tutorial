...
\caption{\small Graphical model representation of a simple phylogenetic model. 
The colapsed graphical model combining all the CTMC variable of the phylogeny.
...
Next, specify the \cl{tree} stochastic node by passing in the tip labels \cl{names} to the \cl{dnUniformTopology()} distribution:
{\tt \begin{snugshade*}
\begin{lstlisting}
