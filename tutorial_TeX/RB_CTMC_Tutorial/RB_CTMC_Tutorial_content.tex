...
\noindent \\ \impmark Look at the file called \cl{output/primates\_cytb\_JC\_posterior.log} in \texttt{Tracer}. There you see the posterior distributions of the continuous parameters, \EG, the clock rate and diversification rates.
