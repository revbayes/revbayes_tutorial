...
Estimating the the marginal likelihood involves integrating the likelihood of the data over the entire prior probability density for the model parameters.
...
%Consequently, these marginal likelihood estimates will be biased. 
