...
Then, we accept the proposal with probability $R$ and reject otherwise (step \ref{sect:MH:step5} of Sect.\ \ref{sect:MH_algorithm}):
{\tt \begin{snugshade*}
\begin{lstlisting}    
...
\begin{figure}[h!]
\centering
\fbox{\includegraphics[width=0.45\linewidth,angle=0]{\ResourcePath figures/archery_MCMC_Trace.pdf}
...
\begin{figure}[h!]
\centering
\fbox{\includegraphics[width=0.7\linewidth,angle=0]{\ResourcePath figures/gamma.pdf}}
