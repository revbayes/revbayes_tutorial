...
See the supplemental of \citet{buerki11} for an explanation.
...
\begin{figure}[!ht]
\centering
\includegraphics[width=0.45\textwidth]{figures/fig_simple_ages.pdf} \includegraphics[width=0.45\textwidth]{figures/fig_epoch_ages.pdf} 
