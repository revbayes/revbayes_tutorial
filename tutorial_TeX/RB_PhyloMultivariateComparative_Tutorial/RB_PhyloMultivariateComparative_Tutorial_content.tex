...
In the directory \cl{RevBayes\_scripts/} you will find a script called \cl{primatesMass\_REML.Rev}.
...
\noindent \\ \impmark Copy the file \cl{primatesMass\_REML.Rev}, name it for example \cl{primatesMass\_Cov.Rev} and start editing it.
...
\noindent \\ \impmark Copy the file \cl{primatesMass\_REML.Rev}, name it for example \cl{primatesMass\_DA.Rev} and start editing it.
