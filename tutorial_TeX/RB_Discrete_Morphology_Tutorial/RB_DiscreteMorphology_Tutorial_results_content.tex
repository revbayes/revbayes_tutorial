...
\fbox{%
\begin{minipage}{\textwidth}\centering
\includegraphics[width=0.92\textwidth,angle=0]{\ResourcePath figures/results/simple_majrule_tre}
...
\fbox{%
\begin{minipage}{\textwidth}\centering
\includegraphics[width=0.92\textwidth,angle=0]{\ResourcePath figures/results/mk_simple_majrule_tre}
\caption{\small Majority rule consensus tree for the uniform Mkv analysis.}
\end{minipage}}
...
\fbox{%
\begin{minipage}{\textwidth}\centering
\includegraphics[width=0.92\textwidth,angle=0]{\ResourcePath figures/results/mk_discretized_majrule_tre}
