...
\fbox{%
\begin{minipage}{\textwidth}\centering
\includegraphics[width=0.9\textwidth,angle=0]{\ResourcePath figures/tracer_tree_length}
...
\fbox{%
\begin{minipage}{\textwidth}\centering
\includegraphics[width=0.9\textwidth,angle=0]{\ResourcePath figures/cats}
...
\fbox{%
\begin{minipage}{\textwidth}\centering
\includegraphics[width=0.9\textwidth,angle=0]{\ResourcePath figures/alpha_beta}
...
\fbox{%
\begin{minipage}{\textwidth}\centering
\includegraphics[width=0.6\textwidth,angle=0]{\ResourcePath figures/summary_tree}
