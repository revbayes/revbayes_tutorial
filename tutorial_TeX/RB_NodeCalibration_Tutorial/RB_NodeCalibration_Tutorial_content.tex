...
\begin{figure}[h!]
\centering
\fbox{\includegraphics[width=\textwidth,angle=0]{\ResourcePath figures/global_clock_graphical_model.pdf}}
...
Finally, we create the stochastic variable representing the character data drawn from the Phylo-CTMC \add{(continuous time Markov chain)} process and attach (clamp) observations to the variable \emph{seq}.}
