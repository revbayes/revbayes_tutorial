...
tree <- read.nexus(file=sprintf("data/%s.tre",treefile) ) 

total <- 19625 # There are about 19625 accepted species of Asteracea according to http://www.theplantlist.org/1.1/browse/A/Poaceae/
